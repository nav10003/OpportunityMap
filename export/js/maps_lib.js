...
var MapsLib = {
  ...
  /*kmlLayer:			  new google.maps.KmlLayer({		// Add KML point layer
						url: 'http://magic.lib.uconn.edu/test/n/kml/DotDensity2.kmz' // NV - temporary link to KML with minority populations
						});
						*/
  ...
  displayKML: function() { // KML Dot Density Layer
	var kmlLayer = new google.maps.KmlLayer({
		url: 'http://magic.lib.uconn.edu/test/n2/kml/dotDensRaster.kmz' // temporary link to KML with minority populations
	});
	kmlLayer.setMap(map);
